                ...
                <tr>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalHapus<?=$data['id_m_pekerja']?>"><i class='bx bxs-trash-alt' > Hapus</i></a>
                                    <a href="#" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target="#modalUbah<?=$data['id_m_pekerja']?>"><i class='bx bxs-edit-alt' > Ubah</i></a>
                                </td>
                            </tr>
