    <!-- Ubah Modal -->
    <div class="modal fade" id="subUbah<?= $data_sub['id_m_sub_pekerjaan']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <!-- Hapus Modal -->
                            <div class="modal fade" id="subHapus<?= $data_sub['id_m_sub_pekerjaan']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
