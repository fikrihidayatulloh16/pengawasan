...
<!-- Tambah Modal -->
<div class="modal fade" id="pengawas_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="../../script/operator_crud.php" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="pengawas_simpan">Simpan</button>
                </div>
            </form>
        </div>
    </div>
