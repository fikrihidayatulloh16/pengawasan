...
<div style="background-color: #f0f0f0; padding: 10px; border-radius: 5px;">
    ...
    <a href="laporanharian.php" class="btn btn-secondary ms-5" ><i class='bx bx-arrow-back' style="margin-right: 5px;"></i>Kembali</a>
    <a href="operator.pekerjaan.php" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target="#modalUbah<?=$data['id_laporan_harian']?>"><i class='bx bxs-edit-alt'>Ubah</i></a>
</div>
...
<div class="container">
    <div class="card mt-3">
        ...
        <table class="table table-striped table-bordered table-thick-border">
            ...
            ?>
            <tr>
                <td class="text-center"><?= $data_sub_pekerjaan['nama_sub_pekerjaan'] ?></td>
                <?php
