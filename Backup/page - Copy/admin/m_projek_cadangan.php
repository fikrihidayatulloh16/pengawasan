<body>
    <h1 class="text-center">ini yg validasi tanggal ubah berhasil namun belum bisa di submit</h1>
                    ...
                    ?>
                            ...
                            <div class="modal fade" id="modalUbah<?=$data['id_projek']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="form_ubah_<?=$data['id_projek']?>" action="../../script/insert.php" method="POST">
                                        <input type="hidden" name="id_projek" value="<?=$data['id_projek']?>">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                            <button type="submit" class="btn btn-primary" name="projek_update">Ubah</button>
                                        </div>
                                    </form>
                                </div>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function validateDates(startDate, endDate, additionalDate, startError, endError, additionalError) {
                ...
                // Validate additional date if provided
                if (additionalDate && additionalDate.value < endDate.value) {
            ...
            while ($data = mysqli_fetch_array($tampil)) :
            ?>
                document.getElementById('form_ubah_<?=$data['id_projek']?>').addEventListener('submit', function(event) {
